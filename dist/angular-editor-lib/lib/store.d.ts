...
export declare type IRefLineDirection = 'tx' | 'bx' | 'ly' | 'ry' | 'cx' | 'cy';
...
export declare type IActionType<T = any> = (state: IStore<T>) => IStore<T>;
export declare const DEFAULT_STORE: IStore<any>;
